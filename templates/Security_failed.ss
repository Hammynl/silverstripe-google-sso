...
<html lang="$ContentLocale">
    ...
    <header class="app-brand">
        <a class="app-brand__link" href="$AbsoluteBaseURL" title="<%t SilverStripe\LoginForms.BackToHomePage "Go back to homepage" %>">
    ...
    <main class="login-form">
        <div class="login-form__header">
            <h2 class="login-form__title">Error</h2>
        </div>

        <% if $Message %>
            <p class="login-form__message login-form__message--warning">
                $Message
            </p>
        <% end_if %>
